...
import com.example.puzzleandbasedatos.MenuPuntuaciones;
import com.example.puzzleandbasedatos.R;

public class PuntosNvl2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_two_points);
        listViewPuntuaciones = findViewById(R.id.puntosListaDos);
        ...
        btnVolverMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PuntosNvl2.this, MainActivity.class);
